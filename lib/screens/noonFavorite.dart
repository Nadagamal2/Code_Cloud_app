...
class NoonTicketFavScreen extends StatefulWidget {
  Widget img;
  String storeName;
  String storeOffer;
  String storeCode;
  ...
  @override
  State<NoonTicketFavScreen> createState() => _NoonTicketFavScreenState();
}

class _NoonTicketFavScreenState extends State<NoonTicketFavScreen> {
            ...
            child: Column(
                ...
                children: [
                  ...
                  Stack(
                    ...
                    children: [
                      SvgPicture.asset('assets/Component 21 – 2.svg'),

                      Padding(
                        padding:   EdgeInsets.only(top: 20.h,right: 25.h,left: 25.h),
                        child: Row(
                      ...
                      Padding(
                        padding:   EdgeInsets.only(top: 40.h,right: 100.h,left: 100.h),
                        child: Center(child:
                        widget.img
                      ...
                      Gap(20.h),
                      Padding(
                        padding:   EdgeInsets.only(top: 200.h,right: 16.h,left: 16.h),
