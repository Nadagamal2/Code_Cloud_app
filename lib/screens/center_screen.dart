...
class _CenterScreenState extends State<CenterScreen> {
  ...
  void creatStore(
    ...
    var request = http.MultipartRequest('POST', Uri.parse('http://saudi07-001-site2.itempurl.com/api/CreateStore'));
  ...
  Future<AdditionModel> getData() async {
    final response = await http.get(
        Uri.parse('http://saudi07-001-site2.itempurl.com/api/GetAll_Addition_Terms'));
  ...
  Widget build(BuildContext context) {
    return userData.read('isLogged')==true &&userData.read('IsSubscriped')== "True"?Scaffold(
appBar:  AppBar(
  ...
  title:  Text("Enter new code".tr(), style: TextStyle(
    fontFamily: 'Tajawal2',
                    ...
                    children: [
                      Padding(
                        ...
                        child: Container(
                            ...
                            child:  Padding(
                              ...
                              child: Column(
                                children: [
                                  Text(LocaleKeys.Addition_terms.tr(),
                                    style: TextStyle(
                                      fontSize: 18.sp,
                                      fontFamily: 'Tajawal2',
                                        ...
                                        child: ListView.separated(
                                            itemBuilder: (context,index)=>  Row(
                                              children: [
                                                ...
                                                Gap(3.h),
                                                Text('${snapshot.data!.records![index].details}',
                                                  style: TextStyle(
                                                    fontSize: 10.sp,
                                                    fontFamily: 'Tajawal7',
                      ...
                      Padding(
                        ...
                        child: Container(
                            ...
                            child:  Padding(
                              ...
                              child: Column(
                                children: [
                                  Text(LocaleKeys.Store_Details.tr(),
                                    style: TextStyle(
                                      fontSize: 18.sp,
                                      fontFamily: 'Tajawal2',
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      contentPadding: EdgeInsets.fromLTRB(10.h, 0, 10, 1.h),
                                      isDense: true,


                                      focusedBorder: UnderlineInputBorder(
                                        borderSide: BorderSide(width: .5.r,color: Colors.grey.shade400),
                                      ...
                                      labelText:   LocaleKeys.Store_name.tr(),
                                      hintText:   LocaleKeys.Store_name.tr(),
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      labelText:   LocaleKeys.Store_link.tr(),
                                      hintText:  LocaleKeys.Store_link.tr(),
                                      labelStyle: TextStyle(
                                          fontSize: 11.sp,
                                          fontFamily: 'Tajawal7',
                                          color: Colors.grey.shade400
                                  ...
                                  Gap(15.h),
                                  Text(LocaleKeys.Download_in_square_dimensions.tr(),
                                    style: TextStyle(
                                      fontSize: 10.sp,
                                      color: Colors.grey.shade400,
                                      fontFamily: 'Tajawal7',
                      ...
                      Padding(
                        ...
                        child: Container(
                            ...
                            child:  Padding(
                              ...
                              child: Column(
                                children: [
                                  Text(LocaleKeys.Discount_details.tr(),
                                    style: TextStyle(
                                      fontSize: 18.sp,
                                      fontFamily: 'Tajawal2',
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      labelText:    LocaleKeys.Offered_discount_code.tr(),
                                      hintText:    LocaleKeys.Offered_discount_code.tr(),
                                      labelStyle: TextStyle(
                                          fontSize: 11.sp,
                                          fontFamily: 'Tajawal7',
                                          color: Colors.grey.shade400
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          creatStore(storeNameController.text.toString(),storelinkController.text.toString(),storeaddressController.text.toString(),storephoneController.text.toString(),storecodeController.text.toString(),storeofferController.text.toString(),storedetailsController.text.toString(),'${userData.read('id')}','${userData.read('country')}',imag!,storeFavController.text.toString());
      ...
      body: Center(
        child: Container(
          child: Column(
            ...
            children: [
              Text(LocaleKeys.You_are_not_subscribed.tr(),style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 17.sp,
              ),),
              Gap(15.h),   Text(LocaleKeys.Login_Please.tr(),style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 17.sp,
              ),),
              Gap(15.h),
              ElevatedButton(
                  ...
                  child: Text( LocaleKeys.Move_to_Login_screen.tr(),))
            ],
          ),
        ),
      ),
